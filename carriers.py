        ...
        try:
            ...
            if len(all_track_results) > 1:
                ...
                if piece_count and str(piece_count) not in ("", "0", "1"):
                    # FedEx knows there are multiple pieces but only returned one result
                    # Build a minimal packages list so the box count gets written
            ...
            return normalize_result(status, delivery_date, location, raw_status, packages=packages_info)
...
# =============================================================================
# UPS Tracking API Ã¢ÂÂ with multi-piece shipment support
# =============================================================================
class UPSTracker:
